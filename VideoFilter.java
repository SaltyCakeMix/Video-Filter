...
public class VideoFilter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        VideoWriter writer = new VideoWriter(args[5], VideoWriter.fourcc('m', 'p', '4', 'v'), FPS, new Size(outW, outH));
        Scalar brightnessScale = new Scalar((chars.length() - 1) / 256.0);
        while(cap.read(frame)){
            ...
            byte[] matrix = new byte[renderW*renderH];
